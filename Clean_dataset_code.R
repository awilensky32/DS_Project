...
#crime rate
final_dataset$Crime.Rate <- (final_dataset$Total.Incidents / final_dataset$AvgPopulation) * 1000
Crime.Rate
...
write.csv(FinalDatasetNoNA, file = "C:\\Users\\User\\Desktop\\final_DatasetNoNa.csv", row.names = FALSE)  
